...
_This implementation enables safe dual-vault operation per Option B strategy, protecting new users while maintaining compatibility with existing V1 assets._
