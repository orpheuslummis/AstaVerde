...
const deployFunc: DeployFunction = async (hre: HardhatRuntimeEnvironment) => {
  ...
  const deployContract = async (contractName: string, args: any[]) => {
    ...
    try {
      ...
      console.log("Fee data after error:", {
        gasPrice: currentFeeData.gasPrice ? ethers.formatUnits(currentFeeData.gasPrice, "gwei") + " gwei" : "N/A",
        maxFeePerGas: currentFeeData.maxFeePerGas ? ethers.formatUnits(currentFeeData.maxFeePerGas, "gwei") + " gwei" : "N/A",
        maxPriorityFeePerGas: currentFeeData.maxPriorityFeePerGas ? ethers.formatUnits(currentFeeData.maxPriorityFeePerGas, "gwei") + " gwei" : "N/A",
      });
      throw error;
    }
  };
  ...
  await deployContract("AstaVerde", [deployer, usdcTokenAddress]);
