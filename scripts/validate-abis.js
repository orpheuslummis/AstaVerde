...
function validateABI(contractName, abiPath) {
    ...
    try {
        ...
        const abiFunctions = artifact.abi
        ...
        if (contractName === 'EcoStabilizer') {
            const getUserLoansIndexed = artifact.abi.find(item => 
...
allValid = validateABI('StabilizedCarbonCoin', 'artifacts/contracts/StabilizedCarbonCoin.sol/StabilizedCarbonCoin.json') && allValid;
