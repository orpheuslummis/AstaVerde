    ...
    it("should handle wallet connection UI", () => {
        ...
        cy.get("body").then(($body) => {
            ...
            const hasWalletContent =
                text.includes("connect") || text.includes("wallet") || text.includes("token") || text.includes("asset");
        ...
        cy.window().its("localStorage").invoke("getItem", "walletConnected").should("equal", "true");
    });
