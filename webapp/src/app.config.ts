...
export const CHAIN_SELECTION = (process.env.NEXT_PUBLIC_CHAIN_SELECTION ||
    "base_sepolia") as ChainSelection;
...
export const ASTAVERDE_CONTRACT_ADDRESS =
...
function validateConfig(): void {
    ...
    if (!ALCHEMY_API_KEY || !WALLET_CONNECT_PROJECT_ID) {
        throw new Error(
            "ALCHEMY_API_KEY and WALLET_CONNECT_PROJECT_ID must be set",
        );
    }
}
...
function logAppConfig() {
    console.log("App Configuration:", {
        ...
        NEXT_PUBLIC_ASTAVERDE_CONTRACT_ADDRESS:
            process.env.NEXT_PUBLIC_ASTAVERDE_ADDRESS,
