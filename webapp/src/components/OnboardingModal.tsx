        ...
        <div className="p-8 overflow-y-auto max-h-[calc(90vh-180px)]">
          <div className="space-y-8">
              ...
              {[
                {
                  ...
                  description: "EcoTradeZone operates on secure blockchain technology. Connect your crypto wallet to participate and ensure the safety of your transactions."
                },
                {
            ...
            <section className="text-center mt-8">
              <p className="text-lg text-gray-700 dark:text-gray-300">By entering EcoTradeZone, you acknowledge that you understand and agree to these terms.</p>
            </section>
          </div>
        </div>
