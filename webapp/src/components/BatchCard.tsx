...
export function BatchCard({ batch, updateCard, isSoldOut }: BatchCardProps) {
  ...
  const buttonContent = (
    <button
      ...
      disabled={isLoading || !isConnected || batch.itemsLeft === 0n || isSoldOut}
  ...
  return (
    <div
      ...
      className={`batch-card hover:shadow-xl ${isSoldOut ? "opacity-50" : ""} dark:bg-gray-800 dark:border-gray-700`}
    >
      <div className="flex flex-col p-4">
        <Link href={`/batch/${batch.batchId}`} className="flex items-center mb-4">
          ...
          <div className="flex-grow">
            <h2 className="text-xl font-semibold dark:text-white mb-1">{`Batch ${batch.batchId}`}</h2>
          ...
          <div className="mt-4">
            <div className="flex justify-between items-center mb-2">
              ...
              <div className="flex items-center">
                ...
                <span className="px-4 py-1 bg-gray-100 dark:bg-gray-600 font-medium">{tokenAmount}</span>
                <button
                  onClick={() => handleTokenAmountChange(tokenAmount + 1)}
