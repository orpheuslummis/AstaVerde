...
export const mockUSDCContractConfig = {
	address: "0x967AB65ef14c58bD4DcfFeaAA1ADb40a022140E5" as `0x${string}`,
	abi: extendedERC20Abi,
} as const;

export const astaverdeContractConfig = {
	// on Base Sepolia
	address: "0xe1708FA6bb2844D5384613ef0846F9Bc1e8eC55E" as `0x${string}`,
	abi: [
		{
			inputs: [
				{
		...
		},
		{
			...
			name: "PlatformBasePriceAdjusted",
			type: "event",
		},
		{
			anonymous: false,
			...
			name: "PlatformPriceFloorAdjusted",
			type: "event",
		},
		{
			anonymous: false,
			...
			name: "PlatformSharePercentageSet",
			type: "event",
		},
		{
			anonymous: false,
		...
		},
		{
			...
			name: "setPlatformSharePercentage",
			outputs: [],
			stateMutability: "nonpayable",
			type: "function",
		},
