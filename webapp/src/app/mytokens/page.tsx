...
export default function MyTokensPage() {
    ...
    const [selectedTokens, setSelectedTokens] = useState<Set<bigint>>(
        new Set(),
    );
    ...
    const fetchTokens = useCallback(async () => {
        ...
        try {
            ...
            if (lastTokenID === undefined || lastTokenID === null) {
                throw new Error(
                    "Failed to fetch last token ID: Received undefined or null",
                );
            }
                    ...
                    <>
                        ...
                        <div className="mt-4 flex justify-center">
                            ...
                            <button
                                ...
                                disabled={currentPage * TOKENS_PER_PAGE >=
                                    tokens.length}
